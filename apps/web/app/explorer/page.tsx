...
function CertificationBadge({ level }: { level: number }) {
  return (
    <span className={`inline-grid h-4 w-4 shrink-0 place-items-center ${level > 0 ? 'text-[#91a0af]' : 'text-[#a8b4c2]'}`} title={level > 0 ? 'Compte certifie' : 'Nouveau compte'} aria-label={level > 0 ? 'Compte certifie' : 'Nouveau compte'}>
