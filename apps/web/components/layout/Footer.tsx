...
const paymentLogos = [
  ...
  { name: 'Wave', src: '/payments/wave-mark.svg', className: 'h-7 w-auto' },
  { name: 'Moov Money', src: '/payments/moov-money-mark.svg', className: 'h-7 w-auto' },
  { name: 'MTN Mobile Money', src: '/payments/mtn-momo-mark.svg', className: 'h-7 w-auto' },
